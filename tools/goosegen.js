...
//
// Uso: node tools/goosegen.js > /tmp/goose.txt
// Depois cole os grupos <g> gerados dentro do <svg> em renderer/index.html.
// Editar a arte = editar a `grid` abaixo (cada caractere é 1 pixel).
const fs = require('fs');
